      ...
      <DialogTrigger asChild>
        ...
        >
          <svg
            ...
            className="smoothie fill-muted-foreground group-hover:fill-primary size-6 transition-all group-hover:scale-105"
            viewBox="0 0 24 24"
          >
        ...
        <DialogHeader>
          ...
          <div className="flex gap-2">
            <div className="group relative flex-1">
              <Bot className="group-focus-within:stroke-primary stroke-muted-foreground absolute left-2 top-1/2 size-6 -translate-y-1/2 transition-all" />
